<!DOCTYPE html>
	...
	<?php include 'top.html/top.html'; ?>
	  ...
	  <fieldset> <legend>New User Signup:</legend>
            ...
            Personality Type: <input type="text" size="6" maxlength="4" name="Personality Type"> (<a href=http://www.humanmetrics.com/cgi-win/JTypes2.asp">Don't know your type?</a>) <br>
